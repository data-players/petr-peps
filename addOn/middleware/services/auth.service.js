      ...
      await ctx.call(
        'ldp.resource.patch',
        {
          ...
          triplesToAdd: [
            ...
            triple(namedNode(webId), namedNode('https://data.petr-peps.data-players.com/ontology#showEmail'), literal('true', namedNode('http://www.w3.org/2001/XMLSchema#boolean'))),
          ],
          webId: 'system'
        }
      );
